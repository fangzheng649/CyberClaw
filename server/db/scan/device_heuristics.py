...
from server.db.helper import is_random_mac

# Rules file path — lives in project config/ directory
MAC_TYPE_ICON_PATH = Path(__file__).resolve().parent.parent.parent.parent / "config" / "device_heuristics_rules.json"
try:
