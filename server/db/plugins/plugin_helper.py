...
from server.db.const import default_tz, fullConfPath  # noqa: E402 [flake8 lint suppression]


# -------------------------------------------------------------------------------
def read_config_file():
    """
    Returns dict of the config file key:value pairs.
    Returns empty dict if the config file does not exist or cannot be read.
    """
    ...
    try:
        ...
        print('[plugin_helper] config file not found, using defaults')
        return {}
